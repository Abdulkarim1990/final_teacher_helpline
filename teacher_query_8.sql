...
-- Canonical Database Schema v8 (Clean)
--
-- This script is IDEMPOTENT: safe to run on both fresh and existing databases.
-- All CREATE TABLE use IF NOT EXISTS, all triggers/procedures use DROP IF EXISTS,
-- all seed data uses INSERT IGNORE or ON DUPLICATE KEY UPDATE.
--
-- Run this in MySQL Workbench against your target database.
-- =============================================================================
